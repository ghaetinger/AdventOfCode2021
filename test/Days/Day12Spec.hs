...
spec = do
  describe "Auxiliar functions" $ do
    it "readRoutes" $
      readRoute "res/day12/example.txt" `shouldReturn` exampleRoutes
  describe "First Question" $ do
    it "Simple Example input" $
      firstQuestion "./res/day12/simple_example.txt" `shouldReturn` 19
    it "Example input" $
      firstQuestion "./res/day12/example.txt" `shouldReturn` 226
    it "Result" $ firstQuestion "./res/day12/input.txt" `shouldReturn` 4707
  describe "Second Question" $ do
    it "Simple Example input" $
      secondQuestion "./res/day12/very_simple_example.txt" `shouldReturn` 36
    it "Example input" $
      secondQuestion "./res/day12/example.txt" `shouldReturn` 3509
